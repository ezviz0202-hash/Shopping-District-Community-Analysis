...
def main():
    print("[1/7] Generating synthetic purchase log and IoT data...")
    ...
    print("[2/7] Building cross-visit network...")
    ...
    print("[3/7] Detecting communities via Louvain...")
    ...
    print("[4/7] Analyzing excitement curves...")
    ...
    print("[5/7] Computing inter-community flow statistics...")
